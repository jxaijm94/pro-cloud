package com.cloud.common.oauth.util;
...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "pro:restPwd";
	private static final String ACTIVE_USER = "pro:activeUser";
	private static final String SEND_SMS_COUNT = "pro:sms:count";
	private static final String SEND_EMAIL_CODE = "pro:email:code";
	private static final String ACCESS_TOKEN = "pro:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "pro:file:upload_file_size";
	...
	public static String createMqKey(String topic, String tag, String refNo, String body) {
		...
		if (refNo.length() > REF_NO_MAX_LENGTH) {
			temp = StrUtil.sub(refNo, 0, REF_NO_MAX_LENGTH) + "...";
		}
