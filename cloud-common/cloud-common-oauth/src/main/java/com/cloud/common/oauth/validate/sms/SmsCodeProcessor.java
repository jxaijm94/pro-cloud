...
import com.cloud.common.oauth.properties.SmsCodeProperties;
import com.cloud.common.oauth.util.RedisKeyUtil;
...
public class SmsCodeProcessor extends AbstractValidateCodeProcessor<ValidateCode> {
	...
	private String getRemoteAddr(HttpServletRequest request) {
		...
		if (ipAddress != null && ipAddress.length() > MAX_IP_LENGTH && ipAddress.indexOf(COMMA, 1) > -1) {
